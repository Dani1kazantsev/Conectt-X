...
function printIde(){
    ...
    html = '<div class="messenger-files__header"><div class="messenger-files__title">' +
        ...
        '<img src="src/img/manifest/icons/files.svg" alt="" class="messenger-files__img">' +
        '<img src="src/img/manifest/icons/folder.svg" alt="" class="messenger-files__img">' +
        '<img src="src/img/manifest/icons/unloading.svg" alt="" class="messenger-files__img">' +
        '</div></div>'
    html += '<div class="messenger-files__files">' +
        '<ul class="messenger-files__list">' +
        `<li id="index.html" class="messenger-files__list-item active"><img src="src/img/manifest/icons/file.svg" alt=""> index.html</li>
        <li id="script.js" class="messenger-files__list-item"><img src="src/img/manifest/icons/file.svg" alt=""> script.js</li></ul></div>`
