...
function printChat(userID){
    ...
    <textarea class="messenger-main__message-text" placeholder="Message"></textarea><div class="messenger-main__push-block"><button type="button" class="messenger-main__emoji"></button> <button type="reset" class="messenger-main__push"onclick='sendMessage(`+obj.id+`)'>
