...
document.querySelector('.web__eye').addEventListener('click',e=>{
    if(document.querySelector('#password').type == "text"){
        ...
        document.querySelector('.web__eye').setAttribute('src','img/manifest/icons/CloseEyePassword.png');
    }
    else{
        document.querySelector('#password').type = "text";
        document.querySelector('.web__eye').setAttribute('src','img/manifest/icons/OpenEyePassword.png');
    }
